...
@pytest.mark.parametrize("input_text, expected",[
    ...
    ("jérôme o’connor", "jerome o'connor"),
    ("  jÉrÔme   O’CoNnOr  ", "jerome o'connor"),
], ids=["john", "john-upper", "john-lower", "john-mixed",
        "spaces-left", "spaces-right", "spaces-both", "spaces-multi",
        "accent-apostrophe", "accent-upper-apostrophe", "accent-lower", "accent-mixed"
        ]
)
...
@pytest.mark.parametrize("input_text, expected",[
    ...
    ("", ""),
    ("   ", ""),
], ids=["john", "leading-spaces", "trailing-spaces", "both-spaces", "double-name", "multi-spaces-both", "multi-word",
         "empty", "only-spaces"
       ]
)
