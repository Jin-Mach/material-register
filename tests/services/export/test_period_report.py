...
def export_data_in() -> list[ExportItemIn]:
    return [
        ExportItemIn(category_name="A", commodity_name="12345", commodity_unit="kg",
        ...
        ExportItemIn(category_name="A", commodity_name="67890", commodity_unit="kg",
                     price_per_unit=7.9, total_quantity=10.0, total_price=79.0),
        ExportItemIn(category_name="B", commodity_name="54321", commodity_unit="kg",
...
def result_data_in() -> dict[str, list[PeriodItemIn]]:
    return {
        "A": [PeriodItemIn(commodity_name="12345", commodity_unit="kg",
        ...
        "B": [PeriodItemIn(commodity_name="54321", commodity_unit="kg",
                            price_per_unit=23.5, total_quantity=5.0, total_price=117.5)
        ]
    }
...
def export_data_out() -> list[ExportItemOut]:
    return [
        ExportItemOut(category_name="A", commodity_name="12345", commodity_unit="kg", total_quantity=600.0),
        ExportItemOut(category_name="A", commodity_name="67890", commodity_unit="kg", total_quantity=100.0),
        ExportItemOut(category_name="B", commodity_name="54321", commodity_unit="kg", total_quantity=100.0)
    ]

@pytest.fixture
def result_data_out() -> dict[str, list[PeriodItemOut]]:
    return {
        "A": [PeriodItemOut(commodity_name="12345", commodity_unit="kg", total_quantity=600.0),
               PeriodItemOut(commodity_name="67890", commodity_unit="kg", total_quantity=100.0)
        ],
        "B": [PeriodItemOut(commodity_name="54321", commodity_unit="kg", total_quantity=100.0)
        ]
    }
...
def test_get_period_data_out(export_data_out: list[ExportItemOut], result_data_out: dict[str, list[PeriodItemOut]]) -> None:
